...
public class StudentListResourceTest extends AbstractShiroTest {
	
	private StudentListResource studentListResource;
	...
	public void initialize() {
		studentListResource = new StudentListResource();
		studentListResource.setRepository(courseInfoRepository);
		...
		studentListResource.setRequest(request);
	}
	...
	public void testCourseList() throws IOException {
		...
		RequestAttributes.setRequestPager(studentListResource.getRequest(), new Pager());
		
		Representation result = studentListResource.getResource();
